  ...
  return <Container>
    ...
    <RightContainer>
      <Space direction="vertical">
        ...
        <DimensionsInput>
          <NumberInput label="Width" value={width} min={0} max={50} callback={setWidth} />
          <NumberInput label="Height" value={height} min={0} max={50} callback={setHeight} />
        </DimensionsInput>
        <Button type="primary" onClick={onSet}>Set Dimensions</Button>
        <Popconfirm
          ...
          cancelText="No"
        >
          <Button type="primary" danger>Reset All Search Data</Button>
        </Popconfirm>
      </Space>
    </RightContainer>
  </Container>
